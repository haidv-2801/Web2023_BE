...
namespace Web2023_BE.Web.Controllers
{
    ...
    /// </summary>
    [ApiController]
    public class FootersController : BaseEntityController<Footer>
    {
        #region Declare
        ...
        #region Constructer
        public FootersController(IFooterService footerService, ILogger<Footer> logger) : base(footerService, logger)
        {
